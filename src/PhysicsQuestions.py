...
physics_long = [
    ...
    {"question": "discus the rinciple an working of a transformer."},
    {"question": "explainthe concept of conservationd their characteristics."},
    {"question": "explain the concept of SHM and write the equation of motion."},
    {"question": "discuss fcrs affeting resistance ofaconductor."},
    {"question": "explain thermal expasin of solids, liquids, ad gases."},
    {"question": "describe the working principle of an electric generator."},
    {"question": "explai typs of friction and methods to reduce friction."},
    {"question": "describ the kinetic theor of gases."},
    {"question": "explain Bernoulli' principleand its applications."},
    {"question": "discuss the laws o thermodynamics with examples."},
    {"question": "explain eecromagnetic induction and Faraday' law."},
    {"question": "descrie the princiption and derive range formula."},
    {"question": "discuss heat engines and Carnot cycle efficiency."},
    {"question": "explain optcal instruments: microcope and telescope principles."},
    {"question": "describe how semicnductrs are used in diodes and transistors."},
